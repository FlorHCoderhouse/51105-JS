...
/* 
let gustos = ['menta granizada','sambayon con almendras','kinotos al whisky','tramontana','crema del cielo']

localStorage.setItem('sabores', JSON.stringify(gustos));

console.log(JSON.parse(localStorage.getItem('sabores'))); */
