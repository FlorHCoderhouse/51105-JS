...
for(let i = 0;i<3;i++){
    let frase = prompt ('Ingresá una frase y la mostraremos en pantalla');
    alert(frase);
} 
...
for (let i = 1; i <= 100; i++) {
    if (i % 3 == 0) {
        console.log('Este es multiplo de 3');
        continue;
    }
    console.log(i);
}
...
/*
//Switch 
//acá les dejo un escape de caracter. Es una pequeña trampita para mostrar las cosas más lindas en el alert. Se escribe \n y sirve para introducir un enter en el string que vienen escribiendo
